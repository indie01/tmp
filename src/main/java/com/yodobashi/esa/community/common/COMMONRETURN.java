...
package com.yodobashi.esa.community.common;
...
public class COMMONRETURN implements CommonReturnIF {
	 ...
	 *
	 */
	private static final long serialVersionUID = -7056733935596648444L;
    ...
    protected COMMONRETURN.ReturnComHeader returnComHeader = new COMMONRETURN.ReturnComHeader();
    @XmlElement(name = "ReturnComDetail")
    protected List<COMMONRETURN.ReturnComDetail> returnComDetail = new ArrayList<COMMONRETURN.ReturnComDetail>();

    public String toString() {
    	return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
    	.append("returnComHeader", returnComHeader)
    	.append("returnComDetail", returnComDetail)
    	.toString();
    }
    ...
    public static class ReturnComDetail implements ReturnComDetailIF {
		 ...
		 *
		 */
		private static final long serialVersionUID = 2375688630305104359L;
        ...
        public String toString() {
        	return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
        	.append("detailStatus", detailStatus)
    ...
    public static class ReturnComHeader implements ReturnComHeaderIF {
		 ...
		 *
		 */
		private static final long serialVersionUID = -4808579546488561038L;
