...
public class TestDataCreators {
	...
	public static class CommunityUserCreator extends DataCreator<CommunityUserDO, TestId.CommunityUserId> {
		...
		@Override
		public void fillItems(CommunityUserDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=1)
	public static class HashCommunityIdCreator extends DataCreator<HashCommunityIdDO, TestId.CommunityUserId> {
		@Autowired DomainConfig domainConfig;
		...
		@Override
		public void fillItems(HashCommunityIdDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=1)
	public static class CommunityNameCreator extends DataCreator<CommunityNameDO, TestId.CommunityUserId> {
		...
		@Override
		public void fillItems(CommunityNameDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=1)
	public static class WelcomeInformationCreator extends DataCreator<InformationDO, TestId.WelcomeInformationId> {
		...
		@Override
		public void fillItems(InformationDO object, DataCreateContext dataCreateContext) {
	...
	public static class CommunityUserImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.CommunityUserImageId> {
		...
		@Override
		public void fillItems(ImageHeaderDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=0.2)
	public static class CommunityUserThumbnailImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.CommunityUserThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=0.2)
	public static class CommunityUserImageCreator extends DataCreator<ImageDO, TestId.CommunityUserImageId> {
		...
		@Override
		public void fillItems(ImageDO object, DataCreateContext dataCreateContext) {
			object.setImageId(dataCreateContext.getCurrentId());
	...
	@CreateCount(perCommunityUser=0.2)
	public static class CommunityUserThumbnailImageCreator extends DataCreator<ImageDO, TestId.CommunityUserThumbnailImageId> {
	...
	public static class ReviewImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.ReviewImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class ReviewThumbnailImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.ReviewThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class ReviewImageCreator extends DataCreator<ImageDO, TestId.ReviewImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class ReviewThumbnailImageCreator extends DataCreator<ImageDO, TestId.ReviewThumbnailImageId> {
	...
	public static class ReviewCreator extends DataCreator<ReviewDO, TestId.ReviewId> {
		...
		@Override
		public void fillItems(ReviewDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=10)
	public static class UserReviewActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
		...
		@Override
		public void fillItems(ActionHistoryDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=10)
	public static class ProductReviewActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=10)
	public static class PurchaseLostProductCreator extends DataCreator<PurchaseLostProductDO, TestId.NullId> {
		...
		@Override
		public void fillItems(PurchaseLostProductDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=10)
	public static class UsedProductCreator extends DataCreator<UsedProductDO, TestId.NullId> {
		...
		@Override
		public void fillItems(UsedProductDO object, DataCreateContext dataCreateContext) {
	...
	public static class ReviewCommentCreator extends DataCreator<CommentDO, TestId.ReviewCommentId> {
		...
		@Override
		public void fillItems(CommentDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=20)
	public static class UserReviewCommentActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=20)
	public static class ReviewCommentAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=20)
	public static class ReviewLikeCreator extends DataCreator<LikeDO, TestId.NullId> {
		...
		@Override
		public void fillItems(LikeDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=20)
	public static class ReviewLikeAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class QuestionImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.QuestionImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class QuestionThumbnailImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.QuestionThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class QuestionImageCreator extends DataCreator<ImageDO, TestId.QuestionImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class QuestionThumbnailImageCreator extends DataCreator<ImageDO, TestId.QuestionThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=10)
	public static class QuestionCreator extends DataCreator<QuestionDO, TestId.QuestionId> {
		...
		@Override
		public void fillItems(QuestionDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=10)
	public static class UserQuestionActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=10)
	public static class ProductQuestionActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	public static class QuestionAnswerImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.QuestionAnswerImageId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class QuestionAnswerThumbnailImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.QuestionAnswerThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class QuestionAnswerImageCreator extends DataCreator<ImageDO, TestId.QuestionAnswerImageId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class QuestionAnswerThumbnailImageCreator extends DataCreator<ImageDO, TestId.QuestionAnswerThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=20)
	public static class QuestionAnswerCreator extends DataCreator<QuestionAnswerDO, TestId.QuestionAnswerId> {
		...
		@Override
		public void fillItems(QuestionAnswerDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=20)
	public static class UserQuestionAnswerActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=20)
	public static class QuestionAnswerAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=20)
	public static class ProductQuestionAnswerActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId>{
		@Override
		protected void beforeCreate(DataCreateContext dataCreateContext) {
			dataCreateContext.readIdList(TestId.QuestionId.class, dataCreateContext.num/4);
			dataCreateContext.readIdList(TestId.QuestionAnswerId.class, dataCreateContext.num);
	...
	@CreateCount(perCommunityUser=20)
	public static class QuestionAnswerActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	public static class QuestionAnswerCommentCreator extends DataCreator<CommentDO, TestId.QuestionAnswerCommentId> {
	...
	@CreateCount(perCommunityUser=40)
	public static class UserAnswerCommentActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=40)
	public static class QuestionAnswerCommentAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=40)
	public static class QuestionAnswerLikeCreator extends DataCreator<LikeDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=40)
	public static class QuestionAnswerLikeAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class ProductSetImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.ProductSetImageId> {
	...
	@CreateCount(perCommunityUser=1)
	public static class UserImageActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	public static class ProductImageCommentCreator extends DataCreator<CommentDO, TestId.ProductSetImageCommentId> {
	...
	@CreateCount(perCommunityUser=8)
	public static class UserImageCommentActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=8)
	public static class UserImageCommentInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=8)
	public static class ProductImageLikeCreator extends DataCreator<LikeDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=8)
	public static class ImageLikeAddInformationCreator extends DataCreator<InformationDO, TestId.NullId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class ProductSetThumbnailImageHeaderCreator extends DataCreator<ImageHeaderDO, TestId.ProductSetThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class ProductSetImageCreator extends DataCreator<ImageDO, TestId.ProductSetImageId> {
	...
	@CreateCount(perCommunityUser=4)
	public static class ProductSetThumbnailImageCreator extends DataCreator<ImageDO, TestId.ProductSetThumbnailImageId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class CommunityUserFollowCreator extends
	DataCreator<CommunityUserFollowDO, TestId.NullId> {
		...
		@Override
		public void fillItems(CommunityUserFollowDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=2)
	public static class UserFollowUserActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.UserFollowUserActionHistoryId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class FollowInformationCreator extends DataCreator<InformationDO, TestId.FollowInformationId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class ProductFollowCreator extends DataCreator<ProductFollowDO, TestId.NullId> {
		...
		@Override
		public void fillItems(ProductFollowDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=2)
	public static class UserFollowProductActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.UserFollowProductActionHistoryId> {
	...
	@CreateCount(perCommunityUser=2)
	public static class QuestionFollowCreator extends DataCreator<QuestionFollowDO, TestId.NullId> {
		...
		@Override
		public void fillItems(QuestionFollowDO object, DataCreateContext dataCreateContext) {
	...
	@CreateCount(perCommunityUser=2)
	public static class UserFollowQuestionActionHistoryCreator extends DataCreator<ActionHistoryDO, TestId.UserFollowQuestionActionHistoryId> {
	...
	// SKUの数
	@CreateCount(perCommunityUser=10)
	public static class PurchaseProductCreator extends DataCreator<PurchaseProductDO, TestId.NullId> {
		...
		@Override
		public void fillItems(PurchaseProductDO object, DataCreateContext dataCreateContext) {
	...
	public static class DecisivePurchaseCreator extends DataCreator<DecisivePurchaseDO, TestId.NullId> {
		...
		@Override
		public void fillItems(DecisivePurchaseDO object, DataCreateContext dataCreateContext) {
			String sku = getSku(dataCreateContext.currentCount * 5);
	...
	@CreateCount(perCommunityUser=10)
	public static class ReviewDecisivePurchaseCreator extends DataCreator<ReviewDecisivePurchaseDO, TestId.NullId> {
		...
		@Override
		public void fillItems(ReviewDecisivePurchaseDO object, DataCreateContext dataCreateContext) {
			String reviewId = dataCreateContext.getId(TestId.ReviewId.class, dataCreateContext.currentCount);
			String sku = getSku(dataCreateContext.currentCount);
			String communityUserId = dataCreateContext.getId(TestId.CommunityUserId.class, dataCreateContext.currentCount/10);
...
//	public static class SlipHeaderCreator extends DataCreator<SlipHeaderDO, TestId.NullId> {
//
//		@Override
//		public void fillItems(SlipHeaderDO object, DataCreateContext dataCreateContext) {
...
//	public static class SlipDetailCreator extends DataCreator<SlipDetailDO, TestId.NullId> {
//
//		@Override
//		public void fillItems(SlipDetailDO object, DataCreateContext dataCreateContext) {
//			String outerCustomerId = new DecimalFormat("0000000000").format(dataCreateContext.currentCount%this.communityUserNum);
//			String slipNo = new DecimalFormat("0000000000").format(dataCreateContext.currentCount);
...
//	public static class ReceiptHeaderCreator extends DataCreator<ReceiptHeaderDO, TestId.NullId> {
//
//		@Override
//		public void fillItems(ReceiptHeaderDO object, DataCreateContext dataCreateContext) {
//			String outerCustomerId = new DecimalFormat("0000000000").format(dataCreateContext.currentCount%this.communityUserNum);
...
//	public static class ReceiptDetailCreator extends DataCreator<ReceiptDetailDO, TestId.NullId> {
//
//		@Override
//		public void fillItems(ReceiptDetailDO object, DataCreateContext dataCreateContext) {
//			String outerCustomerId = new DecimalFormat("0000000000").format(dataCreateContext.currentCount%this.communityUserNum);
//			String receiptNo = new DecimalFormat("0000000000").format(dataCreateContext.currentCount);
...
//	}
	...
	static class DataCreateContext {
		...
		String getId(@SuppressWarnings("rawtypes") Class<? extends TestId.Target> idType, int num) {
