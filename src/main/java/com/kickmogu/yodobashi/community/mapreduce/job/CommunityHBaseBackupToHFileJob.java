...
import com.kickmogu.lib.hadoop.hbase.backup.HBaseBackupToHFileJob;

@Service @Lazy @Scope("prototype")
public class CommunityHBaseBackupToHFileJob extends HBaseBackupToHFileJob {

	
	public CommunityHBaseBackupToHFileJob()  {
		super();
		this.springConfigLocation = "classpath:/mr-context.xml";
		this.mapReduceConfigType = HBaseBackupConfig.class;
	...
	public static int execute(ApplicationContext parentApplicationContext,String[] args) throws Exception {
		return ToolRunner.run(new CommunityHBaseBackupToHFileJob().setParentApplicationContext(parentApplicationContext), args);
	}
