...
import com.kickmogu.lib.hadoop.hbase.backup.HBaseMultiCounterJob;

@Service
@Lazy
@Scope("prototype")
public class CommunityHBaseMultiCounterJob extends HBaseMultiCounterJob {

	public CommunityHBaseMultiCounterJob() {
		super();
	...
	public static int execute(ApplicationContext parentApplicationContext, String[] args) throws Exception {
		return ToolRunner.run(new CommunityHBaseMultiCounterJob().setParentApplicationContext(parentApplicationContext), args);
	}
