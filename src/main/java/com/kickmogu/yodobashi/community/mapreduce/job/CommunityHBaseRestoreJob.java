...
import com.kickmogu.lib.hadoop.hbase.backup.HBaseRestoreJob;

@Service @Lazy @Scope("prototype")
public class CommunityHBaseRestoreJob extends HBaseRestoreJob {


	public CommunityHBaseRestoreJob()  {
		super();
	...
	public static int execute(ApplicationContext parentApplicationContext, String[] args) throws Exception {
		return ToolRunner.run(new CommunityHBaseRestoreJob().setParentApplicationContext(parentApplicationContext), args);
	}
