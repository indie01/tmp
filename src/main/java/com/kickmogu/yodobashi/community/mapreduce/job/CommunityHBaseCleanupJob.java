...
import com.kickmogu.lib.hadoop.hbase.backup.HBaseCleanupJob;

@Service @Lazy @Scope("prototype")
public class CommunityHBaseCleanupJob extends HBaseCleanupJob {

	public CommunityHBaseCleanupJob()  {
		super();
	...
	public static int execute(ApplicationContext parentApplicationContext, String[] args) throws Exception {
		return ToolRunner.run(new CommunityHBaseCleanupJob().setParentApplicationContext(parentApplicationContext),args);
	}
