...
public class AJaxMethodCacheStrategyImpl implements MethodCacheStrategy {
	
	public static final String CLEAR_AJAX_METHOD_CACHE_KEY = "clear.ajax.method.cache";
	...
	public void beforeRequest() {
		HttpSession httpSession = httpSessionHolder.getHttpSession();
		Boolean clearAjaxMethodCache = (Boolean)httpSession.getAttribute(CLEAR_AJAX_METHOD_CACHE_KEY);
		if (clearAjaxMethodCache == null) return;
		if (clearAjaxMethodCache) {
			Map cache = (Map)httpSession.getAttribute(signature);
