...
@SolrSchema
public class UsedProductDO extends BaseWithTimestampDO implements StoppableContents {

	/**
	 *
	 */
	private static final long serialVersionUID = -331227729789632761L;
	...
	/**
	 * @param usedProductId セットする usedProductId
	 */
